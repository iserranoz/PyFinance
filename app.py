...
if nav == "Home":
	...
	col2.image('img/IRONHACK.png',width = 120, use_column_width = False)
	col2.subheader('')
	col2.image('img/st.png',width = 120, use_column_width = False)
	col2.subheader('')
	col2.image('img/py.png',width = 70, use_column_width = False)
	#col1.header('Py Finance')
	col1.image('img/logo.png',width = 180)
	col1.subheader('')
	...
	col1.image('img/IEX1.png',width = 120, use_column_width = True)
	...
	col1.image('img/IEX2.png',width = 120, use_column_width = True)
